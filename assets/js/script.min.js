  ...
  jQuery(document).ready(function (e) {
    ...
    function d(e) {
      ...
      if (e.parents(".cd-headline").hasClass("type")) {
        ...
        l(e.find("i").eq(0), e, a, 50), o(s.find("i").eq(0), s, a, 50);
      } else
    ...
    function l(s, i, a, n) {
      if (
        ...
        s.is(":last-child") && e("html").hasClass("no-csstransitions"))
      ) {
        var r = c(i);
        u(i, r);
      }
    ...
    e(".cd-headline.letters")
      ...
      .each(function () {
        ...
        for (i in a)
          s.parents(".rotate-2").length > 0 && (a[i] = "<em>" + a[i] + "</em>"),
            (a[i] = t
              ? '<i class="in">' + a[i] + "</i>"
              : "<i>" + a[i] + "</i>");
        var n = a.join("");
      ...
      s.each(function () {
        ...
        if (s.hasClass("loading-bar"))
          ...
          var r = s.find(".cd-words-wrapper b"),
            l = 0;
          r.each(function () {
            var s = e(this).width();
            s > l && (l = s);
          }),
            s.find(".cd-words-wrapper").css("width", l);
        }
        setTimeout(function () {
